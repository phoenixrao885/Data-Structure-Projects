//event.cpp for Program# 3 by Tejas Menon, CS163, last edited on 5/21.
//Purpose: This file contains the structure implementations for the node, event and keyword used as funndamental 
...
bool event::display()
{
 ...
 if (s_time) cout << ctime(&s_time) << endl;
 return 1;
}
